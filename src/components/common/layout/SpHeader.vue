...
<template>
	<header
		...
		class="bg-white w-full h-[70px] flex items-center justify-center shadow-sm pl-16"
	>
		<div class="flex w-full items-center sm:justify-between sm:gap-4 px-8">
			<sp-input color="secondary">
				<template #before>
					<button
						type="button"
						class="text-gray-600 transition hover:text-gray-700"
					>
