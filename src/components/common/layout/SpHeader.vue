...
<template>
	<header aria-label="Page Header" class="bg-gray-50 w-full">
			...
			<div class="flex items-center sm:justify-between sm:gap-4">
				<sp-input color="secondary">
					<template #before>
						<button
							type="button"
							class="rounded-md bg-gray-50 p-2 text-gray-600 transition hover:text-gray-700"
						>
				...
				<div
					class="flex items-center justify-between gap-8 sm:justify-end"
				>
